...
@property (nonatomic, assign) NSUInteger maxDataTimestamp;
@property (nonatomic, assign) NSUInteger minDataTimestamp;

@end

@interface XWBaseListModel : NSObject

@property (nonatomic,assign) BOOL isLoading;
@property (nonatomic,assign) NSUInteger startIndex;            // 当前起始页，从1开始
@property (nonatomic,strong) XWPageInfo * pageInfo;
