...
@interface XWListController ()<SNListEmptyViewDelegate>

@property (nonatomic,strong) UIView * content;

@end

@implementation XWListController
...
- (void)initalizeLoading
{
    ...
    __weak __block XWListController * blockSelf = self;
    [self.listModel gotoFirstPage:^(id request,SNServerAPIResultData * result) {
        ...
        {
            [TipHandler showHUDText:result.error.domain inView:blockSelf.view];
...
- (void)triggerLoadMore
{
    ...
    __weak __block XWListController * blockSelf = self;
    [self.listModel gotoNextPage:^(id request,SNServerAPIResultData * result) {
...
@implementation XWListController (listEmptyView)
...
@implementation XWListController (keybord)
...
@implementation XWListController (listErrorView)
