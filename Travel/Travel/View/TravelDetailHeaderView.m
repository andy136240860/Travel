...
- (void)initSubView {
    ...
    CGFloat isConcernedButtonWidth = 50;
    ...
    isConcernedButton = [[UIButton alloc]initWithFrame:CGRectMake(kScreenWidth - kPaddingLeft - isConcernedButtonWidth, avatarImageView.frameY, isConcernedButtonWidth, isConcernedButtonHeight)];
...
- (void)setBackgroundImageURL:(NSString *)backgroundImageURL {
    ...
    [backgroundImageView sd_setImageWithURL:[NSURL URLWithString:_backgroundImageURL] placeholderImage:[UIImage imageNamed:@"TravelHeaderViewBG@2x"]];
}

- (void)setAvatarImageURL:(NSString *)avatarImageURL {
    _avatarImageURL = avatarImageURL;
    [avatarImageView sd_setImageWithURL:[NSURL URLWithString:_avatarImageURL] placeholderImage:[UIImage imageNamed:@"TravelHeaderViewBG@2x"]];
}
